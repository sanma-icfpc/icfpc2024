...
if __name__ == '__main__':
    ...
    print(f'length of lambdaman17 = {len(lambdaman17)}')
    #arg = 'I' + int2icfp(base4_decode('LRUD'))
    arg = 'I' + int2icfp(base4_decode(lambdaman17))
    print(f'path encoded to length {len(arg)}: {arg}')

    print(compress_lambdaman_base4(17, lambdaman17))